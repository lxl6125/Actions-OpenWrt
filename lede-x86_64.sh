...
git clone --depth=1 https://github.com/sbwml/luci-app-alist package/custom/tmp
mv package/custom/tmp/alist package/custom/alist/alist
rm -rf package/custom/tmp

rm -rf feeds/packages/lang/golang
git clone --depth=1 -b 22.x --single-branch https://github.com/sbwml/packages_lang_golang feeds/packages/lang/golang
